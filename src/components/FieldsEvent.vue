      ...
      <el-carousel  trigger="click" type="card" :autoplay="false">
        ...
        >
          <a :href="events.web" target="_blank">
            <el-card
              class="flex-col-reverse justify-center pb-12 w-80 inline-block"
            >
              <el-col class="flex">
                <el-col>
                  <el-row>
                  ...
                  <h2 class="font-bold w-64 text-left truncate">{{ events.name_event }}</h2>
...
onMounted(async () => {
  eventsArr.value = await getEvents(10)
})
