  ...
  <div class="container mt-10 m-auto">
    ...
    <div class="px-8 py-4 bg-[#D1E0DB] rounded-xl">
      ...
      <el-carousel trigger="click" type="card">
        <el-carousel-item class="text-center opacity-100" v-for="events in eventsArr" :key="events._id" :xs="24" :sm="12" :lg="8">
         <a :href="events.web" target="_blank">
         <el-card  class="md:hover:scale-105 hover:duration-500 flex-col-reverse justify-center pb-12 w-80 inline-block">
            <el-col class="flex">
                <el-col >
                 <el-row>
                     <img :src="events.img" alt="" class="w-80 cover h-40 pb-3 cursor-pointer rounded-2xl" :xs="24" :sm="12" :lg="8">
                 </el-row>
